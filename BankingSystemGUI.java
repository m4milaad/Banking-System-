...
public class BankingSystemGUI extends Frame implements ActionListener {
    ...
    private void createMainMenu() {
        ...
        gbc.gridwidth = 1; gbc.insets = new Insets(5, 10, 5, 10); gbc.fill = GridBagConstraints.HORIZONTAL;
    ...
    private void createLoginPanel() {
        ...
        gbc.gridx = 0; gbc.gridy = 3; gbc.gridwidth = 2; gbc.insets = new Insets(20, 10, 5, 10);
    ...
    private void createAccountCreationPanel() {
        ...
        gbc.gridx = 0; gbc.gridy = 6; gbc.gridwidth = 2; gbc.insets = new Insets(20, 10, 5, 10);
    ...
    private void createTransferPanel() {
        ...
        gbc.gridx = 0; gbc.gridy = 4; gbc.gridwidth = 2; gbc.insets = new Insets(20, 10, 5, 10);
    ...
    private void createLoanApplicationPanel() {
        ...
        gbc.gridx = 0; gbc.gridy = 5; gbc.gridwidth = 2; gbc.insets = new Insets(20, 10, 5, 10);
    ...
    private void handleCreateAccount() {
        try {
            ...
            showResult("Please enter a valid account number.");
        }
    }
    ...
    private void handleCloseAccount() {
        try {
            int accountNum = Integer.parseInt(loanIdField.getText());
            BankAccount account = bank.findAccount(accountNum);
